...
public class StatisticRepository {
    ...
    public Call<ApiResponse<StatisticOverviewResponse>> getStatisticOverview(String bearerToken, Instant from, Instant to) {
        return statisticApi.getStatisticOverview(bearerToken, from, to);
    }

    public Call<ApiResponse<List<TimeSeriesPointResponse>>> getRevenueSeries(String bearerToken, Instant from, Instant to, String groupBy) {
        return statisticApi.getRevenueSeries("Bearer " + bearerToken, from, to, groupBy);
    }


    public Call<ApiResponse<List<TimeSeriesPointResponse>>> getOrderSeries(String bearerToken, Instant from, Instant to, String groupBy) {
        return statisticApi.getOrderSeries(bearerToken, from, to, groupBy);
    }

    public Call<ApiResponse<List<ProductStatisticResponse>>> getTopProducts(String bearerToken, Instant from, Instant to, Integer limit) {
        return statisticApi.getTopProducts(bearerToken, from, to, limit);
    }

    public Call<ApiResponse<List<CatalogStatisticResponse>>> getByCatalog(String bearerToken, Instant from, Instant to) {
        return statisticApi.getByCatalog(bearerToken, from, to);
    }

    public Call<ApiResponse<List<CatalogStatisticResponse>>> getByStaff(String bearerToken, Instant from, Instant to) {
        return statisticApi.getByStaff(bearerToken, from, to);
    }

    public Call<ApiResponse<List<StatusStatisticResponse>>> getStatusDistribution(String bearerToken, Instant from, Instant to) {
